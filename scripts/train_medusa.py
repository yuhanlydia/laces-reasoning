...
class MedusaHeads(nn.Module):
    def __init__(self, hidden_dim, vocab_size, num_heads=4):
        super().__init__()
...
def main():
    ...
    ap.add_argument("--save_dir", default="outputs_relay/medusa-rwkv-2.9B")
    ...
    medusa = MedusaHeads(hidden_dim, vocab_size, args.num_heads).to(args.device, dtype)
